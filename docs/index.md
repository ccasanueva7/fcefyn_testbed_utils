...
| **Remote HTTPS Grafana (VPS)** | [URL and access](configuracion/grafana-public-access.md#url-and-access) | Invitation required; contacts in [SOM - Ownership and support](operar/SOM.md#ownership-and-support). Lab stack (Prometheus, local Grafana): [observabilidad](configuracion/observabilidad.md). |
